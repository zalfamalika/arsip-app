<?php
    ...
    if(isset($_GET['hal']))
    {
        ...
        if($data)
        {
            //jika data ditemukan maka data ditampung kedalm variabel
    ...
    <table class="table table-borderd table-hovered table-striped">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="?halaman=departemen&hal=hapus&id=<?=$data['id_departemen']?>" class="btn btn-danger"onclick="return confirm('Apakah yakin ingin menghapus data tersebut?')">Hapus </a>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
